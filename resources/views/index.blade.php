...
<html lang="en">
  ...
  <body>
  <!--Comensamos la barra de navegacion-->
    <!--<div class="cocontainer-fluid bg-dark">
            <div class="container bg-dark">
                <nav class=" navbar navbar-expand-lg navbar-dark bg-dark">
                    <div class="collapse navbar-collapse d-flex justify-content-end">
                        <ul class="navbar-nav">
                        <li class="nav-item">
                            <a style="padding: .0 1rem;" class="nav-link" href="#">Los damascosavenida</a>
                        </li>
                        <li class="nav-item">
                            <a style="padding: .0 0;" class="nav-link" href="#">+51 089 986 298</a>
                        </li>
                        </ul>
                    </div>
                </nav>
    ...
    <div class="container-fluid backsegundario">
        <div class="container backsegundario">
            <div class="header d-flex align-items-center">
                <span class="">
                    <h1 class="header__titulo">ESCUELA PROFESIONAL DE<br> INGENIERÍA EN INFORMATICA Y<br> SISTEMAS</h1>
